...
CREATE INDEX index_subscriptions_on_media_only ON subscriptions USING btree (media_only);
...
CREATE INDEX index_subscriptions_on_show_retweets ON subscriptions USING btree (show_retweets);
